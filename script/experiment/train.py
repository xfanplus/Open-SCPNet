...
from tri_loss.model.SCPNet import get_scp_model
from tri_loss.model.loss import scp_loss
...
class ExtractFeature(object):
    ...
    def __call__(self, ims):
        ...
        feat = self.model(ims)
        feat = torch.cat(feat[1], dim=1).data.cpu().numpy()
...
def main():
    ...
    for ep in range(start_ep, cfg.total_epochs):
        ...
        while not epoch_done:
            ...
            loss, prec = scp_loss(feat, labels_t, criterion_cls, criterion_feature, cfg.ids_per_batch, cfg.ims_per_id)
