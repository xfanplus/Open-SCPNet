...
def create_dataset(
  ...
  if name == 'market1501':
    im_dir = ospeu('/unsullied/sharefs/fanxing/share/data/reid/Market-1501/images')
    partition_file = ospeu('/unsullied/sharefs/fanxing/share/data/reid/Market-1501/partitions.pkl')

  elif name == 'cuhk03':
    im_type = ['detected', 'labeled'][1]
    im_dir = ospeu(ospj('/unsullied/sharefs/fanxing/share/data/reid/cuhk03', im_type, 'images'))
    partition_file = ospeu(ospj('/unsullied/sharefs/fanxing/share/data/reid/cuhk03', im_type, 'partitions.pkl'))

  elif name == 'duke':
    im_dir = ospeu('/unsullied/sharefs/fanxing/share/data/reid/DukeMTMC-reID/images')
    partition_file = ospeu('/unsullied/sharefs/fanxing/share/data/reid/DukeMTMC-reID/partitions.pkl')
